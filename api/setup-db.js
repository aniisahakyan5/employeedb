...
export default async function handler(request, response) {
  try {
    ...
    await sql`
      INSERT INTO employees (name, surname, position, department, dept_priority, phone, email, birthday, vehicle_plate, vehicle_photo)
      VALUES 
        ('Artak', 'Sargsyan', 'CEO', 'Executive', 1, '374 91 123456', 'artak.sargsyan@movato.com', 'January 1', '01-XX-001', 'https://images.unsplash.com/photo-1555215695-3004980ad90b?w=400&q=80'),
        ('Aram', 'Baghdasaryan', 'CTO', 'Executive', 1, '374 93591459', 'aram.baghdasaryan@movato.com', 'January 21', '77-AB-777', 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=400&q=80'),
